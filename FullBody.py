...
class Body:
    ...
    def squat(self):
        ...
        if len(self.__cur_squat_frames) == 0:  # The beginning of the squat
            if abs(cur_height - self.__user_height_in_pixel) < 5:  # If the user is standing - beginning of movement
        ...
        if abs(cur_height - self.__user_height_in_pixel) < 40:  # End or beginning of movement
            if abs(self.__cur_lowest_squat_point - self.__lowest_squat_point) < 30:  # if End - got the low already
