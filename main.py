...
parser.add_argument('--user_height', default=178, type=int, help='Enter the users height')
...
user_body = Body(args.user_height, run_dir)
inWidth = args.width
...
while cv.waitKey(1) < 0:
    ...
    if not standing_line_points:
        standing_line_points = utils.get_standing_line(frameWidth, frameHeight, 0.1, 0.3)
